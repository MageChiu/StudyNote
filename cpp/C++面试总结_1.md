此次整理来自QQ群186588041，所有资料来自谭校长、张教主、H神、Robort、fight for dream、刀刀、二货
主要是总结了一些经常被问道的面试题
欢迎加入群182374342（原来那个群已经解散了）进行讨论和学习
经验不足，水平有限，希望读者能提出宝贵的意见~~~~

----------
<!-- TOC -->

- [1、什么是虚函数？什么是纯虚函数？](#1什么是虚函数什么是纯虚函数)
- [2、基类为什么需要虚析构函数？](#2基类为什么需要虚析构函数)
- [3.、当i是一个整数的时候++i和i++那个更快一点？i++和++i的区别是什么？](#3当i是一个整数的时候i和i那个更快一点i和i的区别是什么)
- [4.、vector的reserve和capacity的区别?](#4vector的reserve和capacity的区别)
- [5、在模板中，如何声明嵌套从属类型(即模板嵌套类型)？](#5在模板中如何声明嵌套从属类型即模板嵌套类型)
- [6、 auto_ptr能作为vector的元素吗？为什么？](#6-auto_ptr能作为vector的元素吗为什么)
- [7、如何初始化const和static数据成员？](#7如何初始化const和static数据成员)
- [8、如何确保对象在抛出异常时也能被删除？什么是RAII？](#8如何确保对象在抛出异常时也能被删除什么是raii)
- [9、 为什么需要private继承？](#9-为什么需要private继承)
- [10、如何实现单例模式？如何避免发生对象的用户复制行为？如何实现线程安全的单例模式？DCLP是什么，有什么问题？](#10如何实现单例模式如何避免发生对象的用户复制行为如何实现线程安全的单例模式dclp是什么有什么问题)
- [11、相等和等价的区别？哪些类型的容器使用相等或等价？](#11相等和等价的区别哪些类型的容器使用相等或等价)
- [12、如何实现仿函数？为什么需要通过继承自unary_function 或者 binary_function来实现仿函数？](#12如何实现仿函数为什么需要通过继承自unary_function-或者-binary_function来实现仿函数)
- [13、如果在构造函数和析构函数中抛出异常会发生什么？什么是栈展开？](#13如果在构造函数和析构函数中抛出异常会发生什么什么是栈展开)
- [14、如何在const成员函数中赋值？](#14如何在const成员函数中赋值)
- [15、两种常用的实现隐式类类型转换的方式是什么？如何避免隐式类型转换？](#15两种常用的实现隐式类类型转换的方式是什么如何避免隐式类型转换)
- [16、STL中的vector：增减元素对迭代器的影响](#16stl中的vector增减元素对迭代器的影响)
- [17、New和malloc的区别](#17new和malloc的区别)
- [18、C++如何避免内存泄漏](#18c如何避免内存泄漏)
- [19、STL中排序算法的实现是什么](#19stl中排序算法的实现是什么)
- [20、指针和引用的区别](#20指针和引用的区别)
- [21、指针数组和数组指针的区别](#21指针数组和数组指针的区别)
- [22、指针函数和函数指针](#22指针函数和函数指针)
- [23、二维动态数组的申请和删除](#23二维动态数组的申请和删除)
- [24、关于shared_ptr使用需要记住什么？](#24关于shared_ptr使用需要记住什么)
- [25、C和C++的区别](#25c和c的区别)
- [26、C++的内存对齐](#26c的内存对齐)
- [27、为什么函数参数的入栈的顺序是从右往左](#27为什么函数参数的入栈的顺序是从右往左)
- [28、C++的多态机制](#28c的多态机制)
- [29、C++中的转化机制？各适用于什么环境？dynamic_cast转换失败时，会出现什么情况？](#29c中的转化机制各适用于什么环境dynamic_cast转换失败时会出现什么情况)
- [30、 拷贝构造函数作用及用途？什么时候需要自定义拷贝构造函数？](#30-拷贝构造函数作用及用途什么时候需要自定义拷贝构造函数)
- [31、构造函数可以调用虚函数吗？语法上通过吗？语义上可以通过吗？](#31构造函数可以调用虚函数吗语法上通过吗语义上可以通过吗)
- [32、深拷贝和浅拷贝的区别](#32深拷贝和浅拷贝的区别)
- [33、动态绑定和静态绑定的区别](#33动态绑定和静态绑定的区别)
- [34、函数模板特化与重载决议中的陷阱](#34函数模板特化与重载决议中的陷阱)
- [35、virtual函数能声明为内联吗？为什么？](#35virtual函数能声明为内联吗为什么)
- [36、哪些类型的对象不可以作为union的成员？为什么有这种限制？](#36哪些类型的对象不可以作为union的成员为什么有这种限制)
- [37、C++11有哪些进步？有哪些新的东西？](#37c11有哪些进步有哪些新的东西)
- [38、如何实现一个不能在堆分配的类，如何实现一个不能被继承的类](#38如何实现一个不能在堆分配的类如何实现一个不能被继承的类)

<!-- /TOC -->
- [1、什么是虚函数？什么是纯虚函数？](#1%E3%80%81%E4%BB%80%E4%B9%88%E6%98%AF%E8%99%9A%E5%87%BD%E6%95%B0%EF%BC%9F%E4%BB%80%E4%B9%88%E6%98%AF%E7%BA%AF%E8%99%9A%E5%87%BD%E6%95%B0%EF%BC%9F)
- [2、基类为什么需要虚析构函数？](#2%E3%80%81%E5%9F%BA%E7%B1%BB%E4%B8%BA%E4%BB%80%E4%B9%88%E9%9C%80%E8%A6%81%E8%99%9A%E6%9E%90%E6%9E%84%E5%87%BD%E6%95%B0%EF%BC%9F)
- [3.、当i是一个整数的时候++i和i++那个更快一点？i++和++i的区别是什么？](#3%E3%80%81%E5%BD%93i%E6%98%AF%E4%B8%80%E4%B8%AA%E6%95%B4%E6%95%B0%E7%9A%84%E6%97%B6%E5%80%99i%E5%92%8Ci%E9%82%A3%E4%B8%AA%E6%9B%B4%E5%BF%AB%E4%B8%80%E7%82%B9%EF%BC%9Fi%E5%92%8Ci%E7%9A%84%E5%8C%BA%E5%88%AB%E6%98%AF%E4%BB%80%E4%B9%88%EF%BC%9F)
- [4.、vector的reserve和capacity的区别?](#4%E3%80%81vector%E7%9A%84reserve%E5%92%8Ccapacity%E7%9A%84%E5%8C%BA%E5%88%AB)
- [5、在模板中，如何声明嵌套从属类型(即模板嵌套类型)？](#5%E3%80%81%E5%9C%A8%E6%A8%A1%E6%9D%BF%E4%B8%AD%EF%BC%8C%E5%A6%82%E4%BD%95%E5%A3%B0%E6%98%8E%E5%B5%8C%E5%A5%97%E4%BB%8E%E5%B1%9E%E7%B1%BB%E5%9E%8B%E5%8D%B3%E6%A8%A1%E6%9D%BF%E5%B5%8C%E5%A5%97%E7%B1%BB%E5%9E%8B%EF%BC%9F)
- [6、 auto_ptr能作为vector的元素吗？为什么？](#6%E3%80%81-autoptr%E8%83%BD%E4%BD%9C%E4%B8%BAvector%E7%9A%84%E5%85%83%E7%B4%A0%E5%90%97%EF%BC%9F%E4%B8%BA%E4%BB%80%E4%B9%88%EF%BC%9F)
- [7、如何初始化const和static数据成员？](#7%E3%80%81%E5%A6%82%E4%BD%95%E5%88%9D%E5%A7%8B%E5%8C%96const%E5%92%8Cstatic%E6%95%B0%E6%8D%AE%E6%88%90%E5%91%98%EF%BC%9F)
- [8、如何确保对象在抛出异常时也能被删除？什么是RAII？](#8%E3%80%81%E5%A6%82%E4%BD%95%E7%A1%AE%E4%BF%9D%E5%AF%B9%E8%B1%A1%E5%9C%A8%E6%8A%9B%E5%87%BA%E5%BC%82%E5%B8%B8%E6%97%B6%E4%B9%9F%E8%83%BD%E8%A2%AB%E5%88%A0%E9%99%A4%EF%BC%9F%E4%BB%80%E4%B9%88%E6%98%AFraii%EF%BC%9F)
...
- [32、深拷贝和浅拷贝的区别](#32%E3%80%81%E6%B7%B1%E6%8B%B7%E8%B4%9D%E5%92%8C%E6%B5%85%E6%8B%B7%E8%B4%9D%E7%9A%84%E5%8C%BA%E5%88%AB)
